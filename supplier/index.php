...
<html lang="en">
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="">Pembeli <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                            ...
                            $no = 1;
                            foreach ($supplier->index() as $data){
                        ?>
                        <tr>
                        ...
                        <td>
                            <a href="show.php?id=<?php echo $data['id_supplier']; ?>" class="btn btn-warning">Show</a> ||
                            <a href="edit.php?id=<?php echo $data['id_supplier']; ?>" class="btn btn-success">Edit</a> ||
